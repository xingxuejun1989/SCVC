...
{
	string file000 = "E:\opencv_test\ICP_Princeton\ICP_Princeton\ICP_Princeton\\bun000.ply";
	string file045 = "E:\opencv_test\ICP_Princeton\ICP_Princeton\ICP_Princeton\\bun045.ply";
	//float icperr;
	//icperr = ICP(TriMesh *mesh1, TriMesh *mesh2, const xform &xf1, xform &xf2,	int verbose, bool do_scale, bool do_affine = false);
	...
	//if (argc - optind < 2)
	//	usage(argv[0]);
	const char *filename1 = "E:\\opencv_test\\ICP_symm\\ICP_symm_pcl\\ICP_symm_pcl\\bun000.ply", *filename2 = "E:\\opencv_test\\ICP_symm\\ICP_symm_pcl\\ICP_symm_pcl\\bun045.ply";
